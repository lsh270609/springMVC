					...
					<form:form action="${root }/user/join_procedure" method="post" modelAttribute="joinUserBean" >
						...
						<div class="form-group">
							...
							<div class="input-group">
								<form:input type="text" path="user_id" onkeypress="resetUserIdExist()" class="form-control"/>
								<form:hidden path="userIdExist"/>
								<div class="input-group-append">
									<form:button type="button" onclick="checkUserIdExist()" class="btn btn-primary">중복확인</form:button>
								</div>
							</div>
